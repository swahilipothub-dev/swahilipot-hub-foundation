  ...
  return (
    <>
      ...
      <main>
        ...
        {/* Centered policies container */}
        <div className="flex justify-center">
          <div className="max-w-3xl w-full">
            {/* Policies container with left margin and max width */}
            <section className="mb-8">
              <h2 className="text-blue-400 font-bold text-xl mb-2">1. Acceptance of Terms</h2>
            ...
            <section className="mb-8">
              <h2 className="text-blue-400 font-bold text-xl mb-2">2. Privacy Policy</h2>
              <p>We respect your privacy. Information collected through this website is governed by our Privacy Policy, which details how we collect, use, and protect your data. Please review the full <a href="https://docs.google.com/document/d/e/2PACX-1vRzaJJkhRJ0xG5u6dVj_KpbSYAtrGYnqkYxFrJ-Z9CQhXUTppLdVgUba5QuCshbLv-BZv7yyYbtBAwW/pub" className="text-blue-600 underline">Privacy Policy</a> for more information.</p>
            </section>

            <section className="mb-8">
              <h2 className="text-blue-400 font-bold text-xl mb-2">3. Terms of Use</h2>
            ...
            <section className="mb-8">
              <h2 className="text-blue-400 font-bold text-xl mb-2">4. Intellectual Property</h2>
              <p>All content on this website—including text, graphics, logos, images, audio, video, and software—is the property of swahilipothub or its licensors and is protected by copyright and other intellectual property laws. You may not reproduce, distribute, or exploit the content without written permission.</p>
            </section>

            <section className="mb-8">
              <h2 className="text-blue-400 font-bold text-xl mb-2">5. User-Generated Content</h2>
            ...
            <section className="mb-8">
              <h2 className="text-blue-400 font-bold text-xl mb-2">6. Third-Party Links</h2>
            ...
            <section className="mb-8">
              <h2 className="text-blue-400 font-bold text-xl mb-2">7. Cookies</h2>
            ...
            <section className="mb-8">
              <h2 className="text-blue-400 font-bold text-xl mb-2">8. Limitation of Liability</h2>
            ...
            <section className="mb-8">
              <h2 className="text-blue-400 font-bold text-xl mb-2">9. Modifications to the Policy</h2>
            ...
            <section className="mb-8">
              <h2 className="text-blue-400 font-bold text-xl mb-2">10. Contact Information</h2>
              ...
              <div className="bg-white shadow-md rounded-xl p-6 mt-4">
                <ul className="space-y-5">
                  ...
                  <li className="flex items-center gap-4">
                    ...
                    <span className="font-semibold text-gray-800 text-lg">Opp. Governor's Office, Butterfly House
