          ...
          <div className="container-custom">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-xl text-gray-700">
                Connect, learn, and grow through our diverse range of events designed to inspire and empower the community.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {events.map(event => (
                <Card key={event.id} className="shadow-md hover:shadow-lg transition-shadow">
                  <CardHeader>
                    <CardTitle>
                      <a href={event.link} className="hover:text-swahilipot-600 transition-colors">
                        {event.title}
                      </a>
                    </CardTitle>
