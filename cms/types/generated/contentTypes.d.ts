...
export interface ApiNewsAndUpdateNewsAndUpdate
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['Blog', 'News', 'Updates']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSphSph extends Struct.SingleTypeSchema {
  collectionName: 'sphs';
  info: {
    description: '';
    displayName: 'Swahilipot Hub Foundation';
    pluralName: 'sphs';
    singularName: 'sph';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::sph.sph'>;
    ...
    official_name: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSwahilipotFmSwahilipotFm extends Struct.SingleTypeSchema {
  collectionName: 'swahilipot_fms';
  info: {
    description: '';
    displayName: 'Swahilipot FM';
    pluralName: 'swahilipot-fms';
    singularName: 'swahilipot-fm';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::swahilipot-fm.swahilipot-fm'
    >;
    logo: Schema.Attribute.Media<'images'>;
    mission: Schema.Attribute.Text;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::sph.sph': ApiSphSph;
      'api::swahilipot-fm.swahilipot-fm': ApiSwahilipotFmSwahilipotFm;
