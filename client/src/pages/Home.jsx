...
function Home() {
  const carouselItems = [
    ...
    },
    {
      ...
      title:
        'Equipping youth with skills and fostering innovation through programs',
              ...
              <div className='h-100'>
                ...
                <div className='bg-light border-bottom border-5 border-primary rounded p-4 mb-4'>
                  <p className='text-dark mb-2'>
                    To empower young people through safe
                    spaces, capacity building, and
                    community-driven programs, enabling them
                ...
                <p className='mb-5'>
                  <b>Vision</b>: A world where youth are
                  catalysts of sustainable and systemic
              ...
              >
                <div className='causes-item d-flex flex-column bg-white border-top border-5 border-primary rounded-top overflow-hidden h-100'>
                  <div className='text-center p-4 pt-0'>
                    ...
                    <p>
                      Tempor erat elitr rebum at clita dolor
